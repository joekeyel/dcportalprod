...
module.exports = function (app) {
 ...
 // app.use(bodyParser.text({ type: 'text/html' }))
    const callapi = app.post('/api/DC_CRAC_UPDATE',(req,res)=>{
        ...
        try {
          ...
          console.log('connected to database');
            ...
            var query1p =  connection.execute(
                ...
                begin
                  dc_hosting.crac_update(
                                         c_id => '`+result['CRAC_ID']+`',
                                         c_name => '`+result['CRAC_NAME']+`',
                                         ...
                                         maintenance_upd => '`+result['CRAC_MAINTENANCE_UPD']+`',
                                         c_updated_by => '`+result['CRAC_UPDATED_BY']+`',
                                         err_message => err_msg);
                end;` ,
                [],                 
              );
